...
public class Constants {
    public static final String TVST_CLIENT_ID = "va0D2CEfSPNNlLoYMYYT";
    public static final String TVST_CLIENT_SECRET = "RF51gSEZBJAbLXmEUCZ8thJAwJPAyQSafCQCyqOt";
    public static final String TVST_USER_AGENT = "plex-tvst-scrobbler";
